 ...
 */
@Data
public class RideStartedPushNotificationView extends PushNotificationView {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(RideStartedPushNotificationView.class);

    public RideStartedPushNotificationView() {
        super("RideStartedPushNotificationView");
