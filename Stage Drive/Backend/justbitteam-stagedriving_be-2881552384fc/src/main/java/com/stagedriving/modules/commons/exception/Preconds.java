...
public final class Preconds {
    ...
    public static void checkConditions(boolean expression, int code, String msg) {
        if (expression) {
            throw new StgdrvInvalidRequestException(Response.Status.BAD_REQUEST, code, msg);
        }
    }

    public static void checkConditions(boolean expression, String msg) {
        if (expression) {
            throw new StgdrvInvalidRequestException(Response.Status.BAD_REQUEST, StgdrvResponseDTO.Codes.INTERNAL_ERROR, msg);
        }
    }
    ...
    public static void checkState(boolean expression, RuntimeException exception) {
        if (!expression && exception==null) {
            throw new IllegalStateException();
        }else if(!expression && exception!=null) {
            throw exception;
        }
    }
    ...
    public static <T> T checkNotNull(T reference, @Nullable Object errorMessage, RuntimeException exception) {
        if (reference == null && exception == null) {
            throw new NullPointerException(String.valueOf(errorMessage));
        } else if (reference == null && exception != null) {
            throw exception;
        } else {
            return reference;
        }
