 ...
 * <p>A created proxy will be aware of the {@link WorkUnit} annotation
 * on the original class methods and will open a Hibernate session with a transaction
 * around them.</p>
 */
public class WorkUnitAwareProxyFactory {

    private final ImmutableMap<String, SessionFactory> sessionFactories;

    public WorkUnitAwareProxyFactory(String name, SessionFactory sessionFactory) {
        sessionFactories = ImmutableMap.of(name, sessionFactory);
    }

    public WorkUnitAwareProxyFactory(HibernateBundle<?>... bundles) {
        ...
        for (HibernateBundle<?> bundle : bundles) {
            sessionFactoriesBuilder.put(HibernateBundle.DEFAULT_NAME, bundle.getSessionFactory());
        }
    ...
    /**
     * Creates a new <b>@WorkUnit</b> aware proxy of a class with the default constructor.
     *
    ...
    /**
     * Creates a new <b>@WorkUnit</b> aware proxy of a class with an one-parameter constructor.
     *
     * @param clazz                the specified class definition
    ...
    /**
     * Creates a new <b>@WorkUnit</b> aware proxy of a class with a complex constructor.
     *
     * @param clazz                 the specified class definition
        ...
        try {
            ...
            proxy.setHandler(new MethodHandler() {
                ...
                public Object invoke(Object self, Method overridden, Method proceed, Object[] args) throws Throwable {
                    final WorkUnit unitOfWork = overridden.getAnnotation(WorkUnit.class);
                    final WorkUnitAspect unitOfWorkAspect = new WorkUnitAspect(sessionFactories);
                    try {
