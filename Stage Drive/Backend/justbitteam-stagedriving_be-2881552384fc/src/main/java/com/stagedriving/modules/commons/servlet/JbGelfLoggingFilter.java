 ...
 */
public class JbGelfLoggingFilter implements Filter {

    private static final Logger LOG = LoggerFactory.getLogger(JbGelfLoggingFilter.class);
...
//        clearMDC();
        ...
        String authorization = httpRequest.getHeader(HttpHeaders.AUTHORIZATION);
        if (authorization != null) {
            MDC.put(AdditionalKeys.AUTHORIZATION, authorization);
        }

        String appId = httpRequest.getHeader("X-Scx-AppId");
        if (appId != null) {
            MDC.put(AdditionalKeys.APP_ID, appId);
        }
        ...
        try {
            ...
            MDC.put(AdditionalKeys.REQ_QUERY, httpRequest.getQueryString());
    ...
    private void clearMDC() {
        ...
        MDC.remove(AdditionalKeys.AUTHORIZATION);
        ...
        MDC.remove(AdditionalKeys.REQ_QUERY);
    ...
    private final class AdditionalKeys {
        ...
        public static final String REQ_QUERY = "requestQuery";
