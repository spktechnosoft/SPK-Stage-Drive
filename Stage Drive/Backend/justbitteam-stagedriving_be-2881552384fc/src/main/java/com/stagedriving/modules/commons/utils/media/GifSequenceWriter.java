...
public class GifSequenceWriter {
    ...
    public void generateGif(List<Image> images, String filename, int ms, boolean loop) throws Exception {
        if (images != null && !images.isEmpty()) {
            ...
            BufferedImage firstImage = ImageIO.read(is);
            ...
            GifSequenceWriter writer =
                    new GifSequenceWriter(output, firstImage.getType(), ms, loop);
            ...
            for (int i = 1; i < images.size(); i++) {
                ...
                BufferedImage nextImage = ImageIO.read(is);
