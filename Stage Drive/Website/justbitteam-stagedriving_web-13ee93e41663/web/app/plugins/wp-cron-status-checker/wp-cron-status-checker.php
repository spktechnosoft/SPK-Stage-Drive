...
function wcsc_run( $forced = false ) {
    ...
    if ( is_wp_error( $result ) ) {
        ...
        $time_string = current_time( 'm/d/Y g:i:s a' );
        $msg = sprintf( __( 'WP-Cron is working as of %s', 'wcsc' ), $time_string );
...
function wcsc_test_cron_spawn() {
    ...
    if ( defined( 'DISABLE_WP_CRON' ) && DISABLE_WP_CRON ) {
        return new WP_Error( 'wcsc_notice', sprintf( __( 'The DISABLE_WP_CRON constant is set to true as of %s. WP-Cron is disabled and will not run.', 'wcsc' ), current_time( 'm/d/Y g:i:s a' ) ) );
    }
