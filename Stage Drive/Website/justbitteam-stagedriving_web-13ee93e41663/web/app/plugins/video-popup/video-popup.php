...
function alobaidi_video_popup_plugin_row_meta( $links, $file ) {
	...
	if ( strpos( $file, 'video-popup.php' ) !== false ) {
		...
		$new_links = array(
						...
						'<a href="http://www.elegantthemes.com/affiliates/idevaffiliate.php?id=24967&tid1=video_popup_plugin_m&url=35248" target="_blank">Elegant Themes</a>',
						'<a href="https://www.bluehost.com/track/wptime/video-popup-plugin-m" target="_blank">Bluehost</a>',
