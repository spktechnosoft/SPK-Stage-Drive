    ...
    public function toMediaManagerAttachment()
    {
        $attachment = array_merge(
            ...
            array(
                ...
                'description' => isset($this->metadata->caption->text) ? trim($this->metadata->caption->text) : '',
                'caption'     => isset($this->metadata->caption->text) ? trim($this->metadata->caption->text) : '', //limit word count?
