...
<form action="" method="get" name="subscribeForm" class="subscribeForm" onsubmit="return false;">
	...
	<fieldset class="subscribeDataTable">
		...
		<?php endif; ?>
		<img class="loading-img" style="display:none;vertical-align:middle;background:none;padding: 5px 3px;" border="0" /><span class="show-response"><noscript><?php _e('Please enable javascript to work with this subscription form.'); ?></noscript></span><p class="muSubmit"><input type="submit" name="submit" value="<?php echo wpml_translate($wpmailup['submitButton'], 'sButton'); ?>" /></p>
	</fieldset>
</form>
<script type="text/javascript">
	...
	jQ(document).ready(function(){
		...
		jQ("body").on("submit", "form.subscribeForm", function(e){
			...
			selectedForm.find('.show-response').html('<?php _e('Invio...'); ?>');
			jQ.post('<?php echo get_bloginfo('wpurl').'/../app/plugins/wp-mailup/subscribe.php'; ?>', form_values, function(returned_data){
				switch(Number(returned_data))
				{
					case 0:
						selectedForm.find('.show-response').html('Grazie! Clicca sul link di attivazione che ti abbiamo appena inviato via mail per confermare la tua iscrizione.');
						break;
					case 1:
