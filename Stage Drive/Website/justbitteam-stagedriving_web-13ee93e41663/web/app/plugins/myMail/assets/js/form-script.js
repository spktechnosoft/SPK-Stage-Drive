jQuery(document).ready(function($) {
	...
	form_structure
	.on('click', '.submitbutton input', function(){
	...
	// .on('click', 'a.field-larger', function(){
	// 	var field = $(this).parent().parent().parent(),
	// 		width = field.data('width'),
	// 		newwidth = Math.min(100, width+5);

	// 		field.css('width', newwidth+'%').data('width', newwidth).find('input.width').val(newwidth);
	// })


	function requireSave(bool){
	...
	.find('.embed-form-input').eq(0).trigger('change');
