<?php
    ...
    $MAILUP_USERNAME = "m111923";
    $MAILUP_PASSWORD = "123justbitere";
    $MAILUP_CLIENT_ID = "a6234569-78aa-4f4f-8f9f-f713c325c59f";
    $MAILUP_CLIENT_SECRET = "814fa9ff-aedf-43d3-a18c-82f90e597b29";
    $MAILUP_CALLBACK_URI = "http://mondoconv.dev:8989/app/themes/sage_new_custom/lib/mailup/index.php";
    ...
    $mailupToken = $mailUp->getAccessToken();
    // }
    // Calling Method
    $callResult = "";
